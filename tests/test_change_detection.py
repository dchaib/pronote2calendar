...
def test_get_changes_add_and_remove():
    ...
    existing_event = create_dummy_event('e1', 'Other', start + timedelta(days=1), end + timedelta(days=1), 'x', 'y')
...
def test_get_changes_update_when_different():
    ...
    existing_event = create_dummy_event('e2', 'Old summary', start, end + timedelta(minutes=30), 'Different', 'Somewhere')
